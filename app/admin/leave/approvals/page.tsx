...
export default function LeaveApprovalsPage() {
  ...
  const handleAction = (id: string, action: 'Approved' | 'Rejected') => {
    setRequests((prev) => prev.map((l) => l.id === id ? { ...l, status: action, approver: 'Admin' } : l));
  ...
  return (
    <div>
      <PageHeader title="Leave Approvals" description="Review and act on leave requests from your team." breadcrumbs={[{ label: 'Admin', href: '/admin/dashboard' }, { label: 'Leave' }, { label: 'Approvals' }]} />
